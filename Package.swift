...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "Nugget",
            url: "https://github.com/BudhirajaRajesh/NuggetSDK/releases/download/0.0.4-Nugget/Nugget.xcframework.zip",
            checksum: "a8ebc4a15c73904f9a77b3e9883642c3dd7c9ce04b4d58a07c9f40dbc587195f"
        ),
