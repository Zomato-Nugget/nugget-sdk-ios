...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "Nugget",
            url: "https://github.com/BudhirajaRajesh/NuggetSDK/releases/download/0.0.7-Nugget/Nugget.xcframework.zip",
            checksum: "d0b0eafc488ad2cec4c31bc816931e2216fed8a8f1b8bec1ce9d660250679a75"
        ),
