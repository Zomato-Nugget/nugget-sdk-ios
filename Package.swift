...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "Nugget",
            url: "https://github.com/Zomato-Nugget/nugget-sdk-ios/releases/download/0.0.4-Nugget/Nugget.xcframework.zip",
            checksum: "88b562db15948f3f2de0d5d3521acf2311bfd050946cd5f1e81436788919f3fd"
        ),
