...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "Nugget",
            url: "https://github.com/Zomato-Nugget/nugget-sdk-ios/releases/download/99.0.8-Nugget/Nugget.xcframework.zip",
            checksum: "f1926c11438825a2853049ede7a12933e06bb2d2a941ee38d0048600062bd836"
        ),
