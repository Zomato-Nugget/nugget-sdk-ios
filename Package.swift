...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "Nugget",
            url: "https://github.com/Zomato-Nugget/nugget-sdk-ios/releases/download/0.0.7-Nugget/Nugget.xcframework.zip",
            checksum: "185effbdede179d9e33a51f37042d4a87a2266db580a559371abeb15f26b30be"
        ),
