...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "Nugget",
            url: "https://github.com/BudhirajaRajesh/NuggetSDK/releases/download/0.0.9-Nugget/Nugget.xcframework.zip",
            checksum: "7bf0ae4c85a6c7b16c768145f309438615805ab62941583fe0fbb61007b7ee7a"
        ),
