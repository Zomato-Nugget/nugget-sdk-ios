...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "Nugget",
            url: "https://github.com/BudhirajaRajesh/NuggetSDK/releases/download/0.0.5-Nugget/Nugget.xcframework.zip",
            checksum: "8cea2a2a9d022a7c66032a17b4989eb4fa6b65609bf88ded0b5cdc168876a818"
        ),
