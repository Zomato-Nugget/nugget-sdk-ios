...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "Nugget",
            url: "https://github.com/Zomato-Nugget/nugget-sdk-ios/releases/download/4.0.8-Nugget/Nugget.xcframework.zip",
            checksum: "3df9f1325f53a347b33b4f20fdcc0152b98e818cfb61e634ec6dc7971435a712"
        ),
