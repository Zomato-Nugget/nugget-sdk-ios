...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "Nugget",
            url: "https://github.com/BudhirajaRajesh/NuggetSDK/releases/download/0.0.3-Nugget/Nugget.xcframework.zip",
            checksum: "6622c90d3f7d1450cf153c166984d9ba5130c588f1f3cf7c9e6b0163b9bf0400"
        ),
