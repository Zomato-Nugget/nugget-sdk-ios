...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "Nugget",
            url: "https://github.com/Zomato-Nugget/nugget-sdk-ios/releases/download/4.0.4-Nugget/Nugget.xcframework.zip",
            checksum: "2a25dc9b16896f80574ac3603568518ab64bf4d3f1d030ecf449dc462441cdcb"
        ),
